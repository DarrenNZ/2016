...
public class FrogSnakeGame{
    ...
    public FrogSnakeGame(){
        ...
        UI.addSlider("Difficulty",2.0,20.0,2.0, this::setSpeed);
        UI.setKeyListener(this::doKey);
        UI.addButton("Quit", UI::quit);
        UI.setDivider(0);
        UI.printMessage("Move mouse to arena and press Space to start, remember to click in graphics pane after changing the difficulty");
        this.drawArenaBug();
        UI.repaintGraphics();
    }
    ...
    private void restartGame(){
        ...
        while (this.frog1!=null && this.frog2!=null) {
            ...
            else if (this.frog2.touching(this.snake1.getX(), this.snake1.getY())) {
                this.frog2.shrink();
            }
            if (this.frog1.touching(this.snake2.getX(), this.snake2.getY())){
                this.frog1.shrink();
            }
            else if (this.frog2.touching(this.snake2.getX(), this.snake2.getY())){
                this.frog2.shrink();
            }
    ...
    public void setSpeed(double snSpeed){
        this.snake1.snakeSpeed(snSpeed);
        this.snake2.snakeSpeed(snSpeed);
    }
