...
public class CartoonFigure {
    ...
    /**
     * makes the user play xbox
     * 
     */
    public void xbox(){
    	this.drawAppliance("xbox", (100*208/231));
    	double energy = 0.089;
    	this.energyUsage += energy;
		UI.printMessage("Playsing Xbox uses "+ energy +"KWH");    
    }
    /**
     * makes the user use the electrical tooth brush
     */
    public void toothBrush(){
    	this.drawAppliance("toothBrush", (100*208/231));
    	double energy = 0.055;
    	this.energyUsage += energy;
    	UI.printMessage("brushing your teeth uses "+ energy + " KWH");
    }
    /**
